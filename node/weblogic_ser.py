...
cat access.* | awk '{if ($7~/wolegecaweblogic.txt/) print $1}' | uniq | sort
'''
ppath = os.path.dirname(os.path.realpath(__file__)) + os.sep + 'static' + os.sep + 'weblogic_poc.bin'
...
def verify(host):
    ...
    try:
        ...
        return False, host+':'+str(port), msg
    except Exception, e:
        msg = str(e)
        return False, host+':'+str(port), msg
